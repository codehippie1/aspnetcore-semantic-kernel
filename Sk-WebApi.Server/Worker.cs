...
namespace Sk_WebApi.Server;

/// <summary>
/// Actual code to run.
/// </summary>
internal sealed class Worker(IHostApplicationLifetime hostApplicationLifetime, [FromKeyedServices("WeatherAutomationKernel")] Kernel kernel) : BackgroundService
{
